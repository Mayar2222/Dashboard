  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div className="w-3/4 p-8 mx-auto overflow-y-auto">
        ...
        <div className="mt-8">
  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Commandes</h3>
  {commandes.map((commande) => (
    <div key={commande.id} className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 p-4 rounded-lg shadow mt-4">
      <p className="text-gray-900 dark:text-gray-100"><strong>Nom et prénom:</strong> {commande.nomPrenom}</p>
      <p className="text-gray-900 dark:text-gray-100"><strong>Produits:</strong> {commande.produits.join(', ')}</p>
      <p className="text-gray-900 dark:text-gray-100"><strong>Promotion:</strong> {commande.promotion}%</p>
      <p className="text-gray-900 dark:text-gray-100"><strong>Adresse Pickup:</strong> {commande.adressePickup}</p>
